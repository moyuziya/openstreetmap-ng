...
This fork default branch only exposes the manually dispatched tests workflow. It checks out one of two explicit source commits (patch 9310e60f49b21c378610fbbe86f5a66b27bb011e by default, or its unchanged upstream baseline 0f27e65e07355d81974b5154d7a982316c1b1363 for comparison) with read-only contents permission, keeps the original Python/Cython matrix and extended tests, and times out jobs after 60 minutes. Auto-update and deployment workflow sources are preserved under .github/disabled-workflows and cannot be dispatched or scheduled there. This override is not part of the upstream delivery patch.
